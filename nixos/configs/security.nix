  ...
  security = {
    ...
    audit = {
      ...
      rules = [
        ...
        "-a always,exit -F arch=b32 -F path=/run/current-system/sw/bin/gpasswd -F perm=x -F auid>=1000 -F auid!=unset -F key=special-config-changes"
        "-a always,exit -F arch=b64 -F path=/run/current-system/sw/bin/gpasswd -F perm=x -F auid>=1000 -F auid!=unset -F key=special-config-changes"
        ...
        "-a always,exit -F arch=b32 -F path=/run/current-system/sw/bin/systemd-run -F perm=x -F auid!=unset -F key=maybe-escalation"
        "-a always,exit -F arch=b64 -F path=/run/current-system/sw/bin/systemd-run -F perm=x -F auid!=unset -F key=maybe-escalation"
        ...
        "-a always,exit -F arch=b32 -F perm=x -F path=/run/current-system/sw/bin/cpan -F key=software-installer"
        "-a always,exit -F arch=b64 -F perm=x -F path=/run/current-system/sw/bin/cpan -F key=software-installer"
